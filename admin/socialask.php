                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="form-icon position-relative">
                                                            ...
                                                            <div class="form-control-select">
                                                                ...
                                                                <option value="whatsapp" <?php echo $isSelectedwp?>>Whatsapp</option>
                                                                </select>
                                                            </div>
                ...
                <table class="table mb-0 table-center">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" class="border-bottom">Approve All</th>
                            <th scope="col" class="border-bottom">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php 
                        $sql = $link->prepare("SELECT * FROM socaltasks ORDER BY id DESC");
                        $sql->execute();
                        ...
                        <tr>
                            ...
                            <td><?php echo $date ?></td>
                            <td><button class="btn btn-sm btn-success completePost">Approve All</button></td>
                            <td>
