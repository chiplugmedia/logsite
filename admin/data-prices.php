...
if ($row) {
    // Assign variables if the product is found
    $name = $row['name'];
        ...
        <div class="card border-0 rounded shadow">
            <div class="card-body">
                ...
                <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="form-icon position-relative">
                                    ...
                                    <input id="productName" type="text" class="form-control ps-5" placeholder="Product Name:" name="productName" value="<?php echo $name; ?>" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="form-icon position-relative">
                                    ...
                                    <textarea id="productDescription" name="productDescription" class="form-control ps-5" placeholder="Product Description:" required><?php echo $description; ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>

                    <!-- Product Price and Social Media Type -->
                    <div class="row mt-4">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label">Product Price</label>
                                <div class="form-icon position-relative">
                                    <input type="number" id="productPrice" name="productPrice" step="0.01" class="form-control ps-5" placeholder="Product Price:" value="<?php echo $price; ?>" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <!-- Product Category and Post Purchase Info -->
                    <div class="row mt-4">
                        <div class="col-md-6">
                            <div class="mb-3">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="form-icon position-relative">
                                    <i data-feather="info" class="fea icon-sm icons"></i>
                                    <textarea id="postPurchaseInfo" name="postPurchaseInfo" class="form-control ps-5" placeholder="Purchase Info:" required><?php echo $purchaseinfo; ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
