...
?>
    ...
    <div class="col-lg-4 mt-4">
         <?php echo $genMsg; ?> <!-- Display any messages from PHP -->
                    ...
                    <div class="row mt-4">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="form-icon position-relative">
                                    ...
                                    <input name="title" id="title" type="text" class="form-control ps-5" placeholder="Email Title:" value="<?php echo isset($title) ? $title : ''; ?>">
                                </div>
                            </div>
                        </div><!--end col-->
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="form-icon position-relative">
                                    <i data-feather="mail" class="fea icon-sm icons"></i>
                                    <textarea name="desc" id="desc" type="textarea" class="form-control ps-5" placeholder="Task Description:"><?php echo isset($desc) ? $desc : ''; ?></textarea>
                                </div>
                            </div> 
                        </div><!--end col-->
                    </div><!--end row-->
