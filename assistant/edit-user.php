...
$fullname=$email=$phone=$funds=$referralFunds=$fbLink=$igLink=$twLink=$ytLink="";
if($numrow > 0){
                                    ...
                                    <form method="POST">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <label for="ref" class="form-label">Referral Balance</label>

                                                <input type="text" class="form-control" id="ref" placeholder=""  name="referralFunds" value="<?php echo $referralFunds?>">
